# -*- coding: utf-8 -*-
"""只重生成 03_搜狐号 20 篇（合规修正版）"""
import os
import sys

sys.path.insert(0, os.path.dirname(os.path.abspath(__file__)))
from topics_data import TOPICS
from gen_md import render_sohu, save_md

BASE_DIR = r"E:\ai项目\考试插件\运营管理\deliverables\2026-07-25-秋招多平台20篇-md"
PLATFORM_DIR = os.path.join(BASE_DIR, "03_搜狐号")

print("重生成 03_搜狐号 20 篇（合规修正版）...")
for topic in TOPICS:
    content = render_sohu(topic)
