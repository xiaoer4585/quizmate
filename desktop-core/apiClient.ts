...
export function createDesktopApiClient(clientPlatform: DesktopClientPlatform): DesktopApiClient {
  async function postActionEnvelope<T = any>(
    endpoint: string,
    action: string,
    input: Record<string, unknown> = {},
    options: PostActionOptions = {}
  ...
  async function postAction<T = any>(
    endpoint: string,
    action: string,
    input: Record<string, unknown> = {},
    options: PostActionOptions = {}
  ...
  return { postActionEnvelope, postAction };
}
