...
export const CREDIT_PACKAGES = [
  { id: "trial", name: "笔试体验包", amount: "19.90", baseCredits: 200, bonusCredits: 10, tag: "限时优惠" },
  { id: "starter", name: "笔试实战包", amount: "49.90", baseCredits: 500, bonusCredits: 100, tag: "热门推荐" },
  { id: "pro", name: "笔试上岸包", amount: "149.00", baseCredits: 1500, bonusCredits: 1000, tag: "性价比之选" },
