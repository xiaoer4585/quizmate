...
const payload = {
  intel: url(`downloads/QuizMate-Mac-Intel-${version}.dmg`, 'application/x-apple-diskimage'),
  ...
  apple: url(`downloads/QuizMate-Mac-Apple-Silicon-${version}.dmg`, 'application/x-apple-diskimage'),
