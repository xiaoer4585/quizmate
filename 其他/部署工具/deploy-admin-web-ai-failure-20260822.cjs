// CHG-20260822-AI-FAILURE 部署：admin-web 增加 AI 失败菜单 / 筛选 / 详情表格
...
const ROLLBACK_OBJECT = 'rollback/CHG-20260822-AI-FAILURE/admin-web.index.before-ai-failure.html';
...
async function main() {
  ...
  // 关键标记自检：本次变更必须命中
  const markers = [
    'data-view-tab="aiFailures"',                       // 侧边栏菜单
    'data-view="aiFailures"',                            // 视图容器
    'aiFailures: "adminListModelCallFailures"',          // table action map
    'populateAiFailureFilters',                          // 筛选下拉填充
    'aiFailureFilters()',                                // 筛选条件函数
    'aiFailureModelType',                                // 模型类型筛选 DOM
    'aiFailureErrorCode',                                // 错误码筛选 DOM
    'aiFailureRequestMode',                              // 请求模式筛选 DOM
    'aiFailureStartDate',                                // 开始时间 DOM
    'aiFailureEndDate',                                  // 结束时间 DOM
    'AI_FAILURE_CODE_MAP',                               // 错误码中文映射
    'MODEL_UPSTREAM_ERROR',                              // 错误码标记
    'MODEL_TIMEOUT: "\u6a21\u578b\u8d85\u65f6"',        // 错误码标记
    'INVALID_MODEL_RESULT: "\u7ed3\u679c\u65e0\u6548"', // 错误码标记
    'MODEL_NOT_CONFIGURED: "\u672a\u914d\u7f6e\u6a21\u578b"' // 错误码标记
  ];
  ...
  process.stdout.write('HAS_AI_FAILURE_UI=true\n');
}
